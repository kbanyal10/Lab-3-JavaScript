...
var storyText = ' <ul class="list-group float-left">' + '<div class="card" style="width: 80rem;">'+
'<div class="card-body">'+"It was 94 farenheit outside, so :insertx: went for a walk. When they got to :inserty:, they stared in horror for a few moments, then :insertz:. Bob saw the whole thing, but he was not surprised — :insertx: weighs 300 pounds, and it was a hot day." + '</div>' + '</div>' + '</ul>';
...
function result() {
  ...
  if(document.getElementById("metric").checked) {
	...
	var paraTest = paras.insertAdjacentHTML("afterend", story);
